package com.custom.viewlibrary.floating;
...
import com.custom.viewlibrary.base.view.BorderView;
import com.custom.viewlibrary.base.view.CornerShadowView;
import com.custom.viewlibrary.base.view.EdgeShadowView;
...
public class ShadowFloating implements ShadowHandler {
   ...
   private void addBorder() {
       BorderView  bw=new BorderView(context,contentView,attr.getBorder(),attr.getCorner());
       shadowViewList.add(bw);
       float leftMargin, topMargin;
       topMargin = contentView.getTop()-attr.getBorder();
       leftMargin = contentView.getLeft()-attr.getBorder();
       ...
       parentLayout.addView(bw, parentLp);
    }
    ...
    private void addEdgeShadow() {
        Log.e("addEdgeShadowDing","attr.getCorner():"+attr.getCorner());
    ...
    private void decorateLeft(EdgeShadowView.Builder edgeShadowBuilder, FrameLayout parentLayout) {
        ...
        float shadowSize;
        float leftMargin, topMargin;
        leftMargin = contentView.getLeft() - attr.getShadowRadius()-attr.getBorder();
        if (attr.getDirection() == CrazyShadowDirection.LEFT) {
            ...
            shadowSize = contentView.getHeight() -  2 * attr.getCorner()+attr.getBorder()*2;
            topMargin = contentView.getTop() + attr.getCorner()-attr.getBorder();
        } else {
    ...
    private void decorateTop(EdgeShadowView.Builder edgeShadowBuilder, FrameLayout parentLayout) {
        ...
        float shadowSize;
        float leftMargin, topMargin;
        topMargin = contentView.getTop() - attr.getShadowRadius()-attr.getBorder();
        if (attr.getDirection() == CrazyShadowDirection.TOP) {
            ...
            shadowSize = contentView.getWidth() - 2 * attr.getCorner()+attr.getBorder()*2;
            leftMargin = contentView.getLeft() + attr.getCorner() -attr.getBorder();
        } else {
    ...
    private void decorateRight(EdgeShadowView.Builder edgeShadowBuilder, FrameLayout parentLayout) {
        ...
        float shadowSize;
        float leftMargin, topMargin;
        leftMargin = contentView.getRight()+attr.getBorder();
    ...
    private void decorateBottom(EdgeShadowView.Builder edgeShadowBuilder, FrameLayout parentLayout) {
        ...
        float shadowSize;
        float leftMargin, topMargin;
        topMargin = contentView.getBottom()+attr.getBorder();
    ...
    private void decorateLeftTop(CornerShadowView.Builder cornerShadowBuilder, FrameLayout parentLayout) {
        ...
        parentLp.leftMargin = (int) (contentView.getLeft() - attr.getShadowRadius()-attr.getBorder());
        parentLp.topMargin = (int) (contentView.getTop() - attr.getShadowRadius()-attr.getBorder());
    ...
    private void decorateRightTop(CornerShadowView.Builder cornerShadowBuilder, FrameLayout parentLayout) {
        ...
        parentLp.leftMargin = (int) (contentView.getRight() - attr.getCorner()+attr.getBorder());
        parentLp.topMargin = (int) (contentView.getTop() - attr.getShadowRadius()-attr.getBorder());
    ...
    private void decorateRightBottom(CornerShadowView.Builder cornerShadowBuilder, FrameLayout parentLayout) {
        ...
        parentLp.leftMargin = (int) (contentView.getRight() - attr.getCorner()+attr.getBorder());
        parentLp.topMargin = (int) (contentView.getBottom() - attr.getCorner()+attr.getBorder());
